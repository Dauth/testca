...
ROOM_PLANS: dict[int, RoomPlan] = {
    ...
    9: RoomPlan(
        ...
        door_bias_blocked_until_groups_clear={
            "upper_right_wave",
            "upper_mid_wave",
            "upper_left_wave",
        },
        route_farthest_from_door=False,
        flank_goals={
            "upper_right_wave": [
                (29, 3),
                (29, 2),
        ...
        force_motion_when_ideal=True,
        notes="Sweep upper wave groups from known firing lanes before moving to the door.",
    ),
    10: RoomPlan(
        room_id=10,
        name="survival room",
