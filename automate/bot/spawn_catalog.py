...
EXTRA_SPAWN_GROUPS: dict[int, dict[str, set[str]]] = {
    ...
    4: {
        "left_wave_grunt": {"wave_left_group"},
        "upper_left_grunt": {"wave_left_group"},
        "left_tank": {"wave_left_group"},
        "left_runner": {"wave_left_group"},
        "lower_right_kamikaze": {"wave_lower_right_group"},
        "far_lower_right_kamikaze": {"wave_lower_right_group"},
    },
    5: {
        "mid_wave_runner": {"wave_obstacle_group"},
        "center_wave_runner": {"wave_obstacle_group"},
        "right_wave_runner": {"wave_river_group"},
        "right_wave_kamikaze": {"wave_river_group"},
        "upper_right_tank": {"wave_river_group"},
        "upper_right_grunt": {"wave_river_group"},
        "upper_mid_grunt": {"wave_river_group"},
    },
    7: {
        "left_lower_runner": {"wave_left_flank_group"},
        "left_mid_wave_runner": {"wave_left_flank_group"},
        "upper_left_tank": {"wave_left_flank_group"},
        "upper_right_runner": {"wave_upper_group"},
        "upper_mid_runner": {"wave_upper_group"},
    },
    9: {
    ...
    10: {
        "bottom_wave_runner": {"bottom_threat_group"},
        "bottom_left_kamikaze": {"bottom_threat_group"},
        "bottom_mid_kamikaze": {"bottom_threat_group"},
        "bottom_right_kamikaze": {"bottom_threat_group"},
        "upper_left_edge_kamikaze": {"edge_kamikaze_group"},
        "upper_mid_kamikaze": {"edge_kamikaze_group"},
        "upper_mid_right_kamikaze": {"edge_kamikaze_group"},
        "upper_right_edge_kamikaze": {"edge_kamikaze_group"},
        "left_edge_kamikaze": {"edge_kamikaze_group"},
        "right_upper_edge_kamikaze": {"edge_kamikaze_group"},
        "right_lower_edge_kamikaze": {"edge_kamikaze_group"},
    },
}
